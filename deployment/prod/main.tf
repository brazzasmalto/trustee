...
module "trustee_aks_cluster" {
  ...
  windows_admin_password                   = module.trustee_random_password.this_password
...
#module "trustee_virtual_machine" {
...
#  boot_diagnostics_storage_account    = module.trustee_storage_account.primary_blob_endpoint
#  log_analytics_workspace_id          = module.trustee_log_analytics_workspace.workspace_id
#  log_analytics_workspace_key         = module.trustee_log_analytics_workspace.primary_shared_key
#  log_analytics_workspace_resource_id = module.trustee_log_analytics_workspace.id
#  log_analytics_retention_days        = var.log_analytics_retention_days
...
#module "trustee_node_pool" {
#  source = "./modules/node_pool"
#  resource_group_name = module.trustee_resource_group.name
#  kubernetes_cluster_id = module.trustee_aks_cluster.id
...
#  vnet_subnet_id               = module.trustee_aks_network.subnet_ids[var.additional_node_pool_subnet_name]
