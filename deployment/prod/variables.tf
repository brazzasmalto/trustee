...
variable "resource_group_name" {
  ...
  type        = string
  default     = "rg-trustee-application-001"
}
...
variable "bastion_host_name" {
  ...
  default     = "trustee-bastion-module"
  type        = string
}
...
variable "key_vault_name" {
  ...
  type        = string
  default     = "trustee-application-001"
}
